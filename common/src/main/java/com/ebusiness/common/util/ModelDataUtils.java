...
import com.ebusiness.common.wx.WxConstants;
...
public class ModelDataUtils {
	...
	public static <T> T getPojoMatch(Class<T> t, Map<String, Object> paramMap)throws Exception{
		...
		String[] dateFormats = new String[] {
				WxConstants.DATE_FORMAT_1, 
				WxConstants.DATE_FORMAT_2, 
				WxConstants.DATE_FORMAT_3, 
				WxConstants.DATE_FORMAT_4,
				WxConstants.DATE_FORMAT_5};
	...
	public static <T> T getPojoMatch(Class<T> t, String str) throws Exception{
		String[] dateFormats = new String[] {WxConstants.DATE_FORMAT_1, WxConstants.DATE_FORMAT_2, WxConstants.DATE_FORMAT_3};
		JSONUtils.getMorpherRegistry().registerMorpher(new DateMorpher(dateFormats)); 
		if(str == null)
			str = "";
		List<String> pojoField = getPojoFieldList(t);
