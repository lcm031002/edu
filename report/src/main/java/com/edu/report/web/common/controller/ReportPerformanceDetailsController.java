...
public class ReportPerformanceDetailsController {
    ...
    @RequestMapping(value = { "/performanceDetails" }, method = RequestMethod.GET, headers = { "Accept=application/json" })
    @ResponseBody
    public Map<String, Object> selectForPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            Page<TPerformanceDetails> page = this.performanceDetailsService.selectForPage(paramMap);

            PageInfo<TPerformanceDetails> pageData = new PageInfo<TPerformanceDetails>(page.getResult());
