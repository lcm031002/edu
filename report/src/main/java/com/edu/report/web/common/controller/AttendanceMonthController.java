...
public class AttendanceMonthController{
	...
	private static final Logger log = Logger.getLogger(AttendanceMonthController.class);

	@Resource(name = "attendanceMonthService")
	private AttendanceMonthService attendanceMonthService;
    @Autowired
    private UserPermissionService userPermissionService;

	@RequestMapping(value = { "/monthattendance" }, method = RequestMethod.GET, headers = { "Accept=application/json" })
	@ResponseBody
	public Map<String, Object> queryReport(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			List<TAttendanceMonthReport> queryResult = attendanceMonthService.queryReport(queryParam);
	...
	@RequestMapping(value = { "/monthattendance_output" }, method = RequestMethod.GET, headers = { "Accept=application/json" })
	@ResponseBody
	public Map<String, Object> outputReport(HttpServletRequest request, HttpServletResponse response) {
		...
		// 模板文件名
		String templateFileName = "month_attendance.xlsx";
		// 临时文件名
		String tempFileName = "月度消耗表" + "【#bu_name#】_"
		...
		try {
			...
			List<TAttendanceMonthReport> queryResult = attendanceMonthService.queryReport(paramMap);
