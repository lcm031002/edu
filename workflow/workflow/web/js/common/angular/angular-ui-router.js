 ...
 * @return {Number} Returns the array views value of `value`, or `-1` if not present.
 */
...
function $UrlMatcherFactory() {
   ...
   * array, using the array views as the URL-encoded value:
   *
   * <pre>
   ...
   *     // Represent the list item in the URL using its corresponding views
   *     return list.indexOf(item);
   *   },
   *   decode: function(item) {
   *     // Look up the list item by views
