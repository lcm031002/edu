...
function EmployeeCtrl($scope,
    ...
    function queryEmployee(){
    	...
    	if($scope.selectedDept){
    		param.dept=$scope.selectedDept;
    		}
    	if($scope.selectedPostId){
    		param.post=$scope.selectedPostId;
    	}
    	if($scope.selectedEnterType){
    		param.enterType=$scope.selectedEnterType;
    	}
    	if($scope.selectedName){
    		param.employee_name=$scope.selectedName;
    	}
